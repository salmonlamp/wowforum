...
class FroalaEditor(widgets.Textarea):
    def __init__(self, *args, **kwargs):
        ...
        self.third_party_with_css = kwargs.pop(
            'third_party_with_css',
            getattr(settings, 'FROALA_EDITOR_THIRD_PARTY_WITH_CSS', THIRD_PARTY_WITH_CSS)
        )
    ...
    def get_options(self):
        ...
        default_options = {
            ...
            'toolbarButtons': [
                ...
                [
                    "bold", "italic", "underline", "paragraphFormat", "fontSize",
                    "fontFamily", "textColor", "backgroundColor",
                ],
                ["alignLeft", "alignCenter", "alignRight", "alignJustify"],
                ["formatOL", "formatUL", "indent", "outdent"],
                ["insertLink", "insertImage", "quote", "emoticons", "accordion"]
            ],
        }
    ...
    def _media(self):
        ...
        for plugin in self.third_party:
            ...
            if plugin in self.third_party_with_css:
